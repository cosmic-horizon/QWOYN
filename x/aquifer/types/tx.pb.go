...
func init() {
	proto.RegisterType((*MsgDepositIntoOutpostFunding)(nil), "cosmichorizon.qwoyn.aquifer.MsgDepositIntoOutpostFunding")
	proto.RegisterType((*MsgDepositIntoOutpostFundingResponse)(nil), "cosmichorizon.qwoyn.aquifer.MsgDepositIntoOutpostFundingResponse")
	proto.RegisterType((*MsgWithdrawFromOutpostFunding)(nil), "cosmichorizon.qwoyn.aquifer.MsgWithdrawFromOutpostFunding")
	proto.RegisterType((*MsgWithdrawFromOutpostFundingResponse)(nil), "cosmichorizon.qwoyn.aquifer.MsgWithdrawFromOutpostFundingResponse")
	proto.RegisterType((*EventDepositIntoOutpostFunding)(nil), "cosmichorizon.qwoyn.aquifer.EventDepositIntoOutpostFunding")
	proto.RegisterType((*EventWithdrawFromOutpostFunding)(nil), "cosmichorizon.qwoyn.aquifer.EventWithdrawFromOutpostFunding")
}

func init() { proto.RegisterFile("aquifer/tx.proto", fileDescriptor_998c0a138c8bb0b7) }
...
func (c *msgClient) DepositIntoOutpostFunding(ctx context.Context, in *MsgDepositIntoOutpostFunding, opts ...grpc.CallOption) (*MsgDepositIntoOutpostFundingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmichorizon.qwoyn.aquifer.Msg/DepositIntoOutpostFunding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawFromOutpostFunding(ctx context.Context, in *MsgWithdrawFromOutpostFunding, opts ...grpc.CallOption) (*MsgWithdrawFromOutpostFundingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmichorizon.qwoyn.aquifer.Msg/WithdrawFromOutpostFunding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_DepositIntoOutpostFunding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmichorizon.qwoyn.aquifer.Msg/DepositIntoOutpostFunding",
	}
...
func _Msg_WithdrawFromOutpostFunding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmichorizon.qwoyn.aquifer.Msg/WithdrawFromOutpostFunding",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
